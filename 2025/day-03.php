 ...
 * When you get to the main elevators, however, you discover that each one has a red light above it:
 * they're all offline.
 *
...
$batteries = file(__DIR__ . '/inputs/day-03.input', FILE_IGNORE_NEW_LINES);

$sum = $joltage->findMaximumJoltage($batteries);
print('The maximum joltage of all batteries is ' . $sum . ".\n");
 ...
 * only difference is that now there will be 12 digits in each bank's joltage output instead of two.
 *
