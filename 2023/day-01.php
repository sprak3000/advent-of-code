...
$calibrationParser = new CalibrationParser();

$calibrationValues = file(__DIR__ . '/inputs/day-01.input', FILE_IGNORE_NEW_LINES);
$calibrationSum = $calibrationParser->findCalibrationSum($calibrationValues);
print('The sum of the calibration values based only on integers is ' . $calibrationSum . ".\n");
...
$calibrationSum = $calibrationParser->findCalibrationSum($calibrationValues, true);
print('The sum of the calibration values based on integers and words is ' . $calibrationSum . ".\n");
