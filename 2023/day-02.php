...
$gameResultParser = new GameResultParser();

$games = file(__DIR__ . '/inputs/day-02.input', FILE_IGNORE_NEW_LINES);
$result = $gameResultParser->parseGameData($games, 12, 13, 14);
$possibleGameIDsSum = $result['possibleGameIDsSum'];
$minimumPowerSum = $result['minimumPowerSum'];

print(
    "The sum of the game IDs possible for only 12 red, 13 green, and 14 blue cubes is {$possibleGameIDsSum}.\n"
);
...
print(
"The sum of the minimum powers for each game set is {$minimumPowerSum}.\n"
);
