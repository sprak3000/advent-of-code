...
$depthCheck = new DepthCheck();

$depths = file(__DIR__ . '/inputs/day-01.input', FILE_IGNORE_NEW_LINES);
$increases = $depthCheck->findDepthIncreases($depths);
print('The number of depth increases were ' . $increases . ".\n");
...
$depths = file(__DIR__ . '/inputs/day-01.input', FILE_IGNORE_NEW_LINES);
$increases = $depthCheck->findDepthIncreasesBySlidingWindow($depths);
print('The number of depth increases via sliding window were ' . $increases . ".\n");
