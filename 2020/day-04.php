...
$data = $passports->import(__DIR__ . '/inputs/day-04.input');
$valid = $passports->validate($data);
$numberValid = count($valid);

print("There are {$numberValid} valid passports in the data using loose validation.\n");
...
$valid = $passports->validate($data, true);
$numberValid = count($valid);

print("There are {$numberValid} valid passports in the data using strict validation.\n");
