...
$result = $passwords->validSledRentalPasswords($entries);
print('There are ' . count($result) . ' valid Sled Rental passwords.' . "\n");
...
$result = $passwords->validTobogganCorporatePasswords($entries);
print('There are ' . count($result) . ' valid Toboggan Corporate passwords.' . "\n");
