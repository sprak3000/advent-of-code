...
$input = file(__DIR__ . '/inputs/day-01.input', FILE_IGNORE_NEW_LINES);
$result = $expenseReport->findTwoThatSumsTo($sumToFind, $input);
$product = $result[0] * $result[1];
print('The numbers ' . $result[0] . ' and ' . $result[1] . ' add up to 2020. Their product is ' . $product . "\n");
