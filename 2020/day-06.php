...
$customsForms = new CustomsForms();

$forms = $customsForms->import(__DIR__ . '/inputs/day-06.input');
$yesResponses = $customsForms->anyoneYesResponses($forms);

print("There were {$yesResponses} yes responses by anyone.\n");
...
$yesResponses = $customsForms->everyoneYesResponses($forms);

print("There were {$yesResponses} responses where everyone said yes.\n");
