...
$fuel = $fuelCalculator->totalUsage($masses);

echo "You will need {$fuel['total']} total fuel for the modules.\n";
...
$totalFuel = $fuel['total'] + $fuel['additional'];
echo "You will need {$fuel['additional']} fuel resulting in {$totalFuel} needed.\n";
