...
$data = $dutyLog->whoSleepsTheMost($logs);
$result = $data['ID'] * $data['bestMinute'];

echo "Who sleeps the most: Guard ID {$data['ID']} * Best Minute {$data['bestMinute']} = {$result}\n";
...
$data = $dutyLog->whoSleepsTheMostOnTheSameMinute($logs);
$result = $data['ID'] * $data['bestMinute'];

echo "Who sleeps the most on the same minute: Guard ID {$data['ID']} * Best Minute {$data['bestMinute']} = {$result}\n";
