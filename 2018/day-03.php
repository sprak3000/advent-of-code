...
$overlaps = $fabric->overlaps($claims);

echo "There are {$overlaps} square inches of overlapping fabric.\n";
...
$claimID = $fabric->doesNotOverlap($claims);
echo "Claim ID {$claimID} does not overlap.\n";
