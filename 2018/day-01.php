...
$result = $frequency->applyChanges(0, $changes);

echo "The resulting frequency is {$result}.\n";
...
$result = $frequency->findFirstDuplicate(0, $changes);

echo "The first duplicate frequency encountered is {$result}.\n";
