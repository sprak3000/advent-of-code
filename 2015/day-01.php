...
$floorLocator = new FloorLocator();

$input = file_get_contents(__DIR__ . '/inputs/day-01.input');
$floor = $floorLocator->WhereAmI($input);
...
$basementReachedOnStep = $floorLocator->WhenDoIReachTheBasement($input);
print("You reached the basement on step " . $basementReachedOnStep . "\n\n");
