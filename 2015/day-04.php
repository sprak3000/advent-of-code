 ...
 * Santa needs help [mining](https://en.wikipedia.org/wiki/Bitcoin#Mining) some AdventCoins (very similar to bitcoins)
...
$adventCoin = new AdventCoin();
$input = file_get_contents(__DIR__ . '/inputs/day-04.input');

$hash = $adventCoin->Mine($input);
print('Advent Coin hash starting with five zeroes is "' . $hash . '"' . ".\n");
...
$hash = $adventCoin->Mine($input, 6);
print('Advent Coin hash starting with size zeroes is "' . $hash . '"' . ".\n");
