...
$result = $niceString->CheckStrings($input);
print("There were " . count($result['nice']) . " nice strings using default mode.\n");
...
$result = $niceString->CheckStrings($input, NiceString::MODE_V2);
print("There were " . count($result['nice']) . " nice strings using mode V2.\n");
