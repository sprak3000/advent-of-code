...
$calculator = new PresentMaterialsCalculator();
$input = file(__DIR__ . '/inputs/day-02.input');
$calculator->calculate($input);
print("You will need " . $calculator->getWrappingPaperSquareFeet() . " square feet of wrapping paper.\n");
...
print("You will need " . $calculator->getRibbonFeet() . " feet of ribbon.\n");
