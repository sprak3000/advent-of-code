...
$houseLights = new HouseLights();
$instructions = file(__DIR__ . '/inputs/day-06.input');

$houseLights->followInstructions($instructions);
print("There were " . $houseLights->lightsLit() . " lights lit.\n");
...
$houseLights->reset();
$houseLights->followBrightnessInstructions($instructions);
print("The total brightness of the lights is " . $houseLights->totalBrightness() . ".\n");
