...
$map = $presentDelivery->MakeDeliveries($input);
print("Santa delivered presents to " . count($map) . " houses.\n");
...
$map = $presentDelivery->MakeRoboDeliveries($input);
print("Santa and Robo-Santa delivered presents to " . count($map) . " houses.\n");
