...
$calories = file(__DIR__ . '/inputs/day-01.input', FILE_IGNORE_NEW_LINES);
$maxCalories = $calorieCounter->findMaxCaloriesCarried($calories);
print('The maximum number of calories carried is ' . $maxCalories . ".\n");
...
$maxCalories = $calorieCounter->findTopThreeCaloriesCarriedTotal($calories);
print('The maximum number of calories carried by the the top three elves is ' . $maxCalories . ".\n");
