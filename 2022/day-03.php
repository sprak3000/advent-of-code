...
$sacks = file(__DIR__ . '/inputs/day-03.input', FILE_IGNORE_NEW_LINES);
$totalPriority = $rucksack->findDuplicatePriorityTotal($sacks);
print('The total of the priorities of duplicate items in the sacks is ' . $totalPriority . ".\n");
...
$totalBadgePriority = $rucksack->findBadgePriorityTotal($sacks);
print('The total of the priorities of badges in the sacks per group is ' . $totalBadgePriority . ".\n");
