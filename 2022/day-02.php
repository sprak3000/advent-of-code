...
$strategy = file(__DIR__ . '/inputs/day-02.input', FILE_IGNORE_NEW_LINES);
$totalScore = $rps->findTotalScoreWrongAssumption($strategy);
print('Assuming both columns are shape indicators, the total score would be ' . $totalScore . ".\n");
...
$totalScore = $rps->findTotalScore($strategy);
print("Given the first column is the opponent's shape and the second column is the round outcome, the total score is ");
print($totalScore . ".\n");
