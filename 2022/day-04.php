...
$ca = new CleaningAssignment();

$assignments = file(__DIR__ . '/inputs/day-04.input', FILE_IGNORE_NEW_LINES);
$completeOverlaps = $ca->findCompleteOverlaps($assignments);
print('The total number of complete overlaps for assignments is ' . $completeOverlaps . ".\n");
...
$anyOverlaps = $ca->findAnyOverlaps($assignments);
print('The total number of assignments with any overlaps is ' . $anyOverlaps . ".\n");
