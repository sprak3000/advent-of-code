...
$crane = new CargoCrane();

$instructions = __DIR__ . '/inputs/day-05.input';
$crates = [
    ['W', 'T', 'H', 'P', 'J', 'C', 'F'],
    ['H', 'B', 'J', 'Z', 'F', 'V', 'R', 'G'],
    ['R', 'T', 'P', 'H'],
...
$topCrates = $crane->findTopCrates($instructions, $crates, 10, true);
print('The top crates using single move crane are ' . $topCrates . ".\n");
...
$topCrates = $crane->findTopCrates($instructions, $crates, 10);
print('The top crates using multi move crane are ' . $topCrates . ".\n");
