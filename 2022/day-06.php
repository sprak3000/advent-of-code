 ...
 * [significant experience dealing with signal-based systems](https://adventofcode.com/2016/day/25), he convinced
...
$inputStream = file_get_contents(__DIR__ . '/inputs/day-06.input');
$start = $comm->findCharactersToDetectMarker($inputStream, Communicator::MARKER_LENGTH_START_OF_PACKET);
print('Processed ' . $start . " characters to find the start of packet marker.\n");
...
$start = $comm->findCharactersToDetectMarker($inputStream, Communicator::MARKER_LENGTH_START_OF_MESSAGE);
print('Processed ' . $start . " characters to find the start of message marker.\n");
